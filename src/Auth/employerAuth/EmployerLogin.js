                                ...
                                <Col md={6}>
                                    <CardBody>
                                        ...
                                        <p className="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="#!"
                                            className="link-danger" onClick={() => navigate("/employer/sign-up")}>Register as a employer</a></p>
                                        <Button className="mt-3" color="success" onClick={() => navigate("/teacher/sign-in")}>
                                            <GiTeacher /> Login As Teacher</Button>

                                    </CardBody>
                                </Col>
                                <div className="col-md-6 col-lg-7 col-xl-6 d-none d-sm-block">
                                    <img src={require("../../images/employer.jpg")}
