                ...
                <Row className='mt-5'>
                    <Col md={6}>
                        <Card className='shadow p-4 index-card' style={{ border: 'none', borderRadius: 20 }}>
                            <Row>
                                <Col md={2}>
                                    <User style={{ color: 'rgb(74, 74, 74)', float: '' }} size='4.5em' />
                                </Col>
                                <Col md={6}>
                                    <p className='m-0 user-name'>Yasir Ado</p>
                    ...
                    <Col md={3}>
                        <Card className='card shadow p-4' style={{ border: 'none', borderRadius: 20 }}>
                            ...
                            <Row>
                                <Col><p style={{ fontWeight: 'bold', fontSize: 70, color: 'rgb(74, 74, 74)' }}>0%</p></Col>
                                <Col><p></p><Heart style={{ color: 'rgb(74, 74, 74)', float: 'right' }} size='4.5em' /></Col>
                            </Row>
                            ...
                            <Row>
                                <Col md={6}>
                                    <Card className='shadow-sm p-4 index-card' style={{ border: '', borderRadius: 10 }}>
                                        ...
                                        <button className='events ee' style={{ float: '' }}>
                                            View Profile
                                        </button>
                                    </Card>
                                </Col>
